...
describe 'schema/partials/ref.xsl' do
  context 'iswc-list' do
    it 'works' do
      transform_grammar(%Q{<define name="def_work-element">
        <element name="work">
          <optional><ref name="def_iswc-list"/></optional>
          <optional/>
        </element>
      </define>
      <define name="def_iswc-list">
        <element name="iswc-list"><ref name="def_list-attributes"/><zeroOrMore><ref name="def_iswc-element"/></zeroOrMore></element>
      </define>
      <define name="def_iswc">
        <data type="string"><param name="pattern">[A-Z]-[0-9]{3}\.[0-9]{3}\.[0-9]{3}-[0-9]</param></data>
      </define>}).should == strip_xml(%Q{<work>
        <attributes/><elements/>
        <refs>
          <iswc-list>
            <resource><name>iswc</name><type><name>String</name><comment>[A-Z]-[0-9]{3}\\.[0-9]{3}\\.[0-9]{3}-[0-9]</comment></type></resource>
          </iswc-list>
        </refs>
      </work>})
    end  
